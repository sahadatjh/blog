            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="access_label" class="col-md-4 col-form-label text-md-right">{{ __('Access Lebel') }}</label>

                            <div class="col-md-6">
                                <select id="access_label" class="form-control @error('access_label') is-invalid @enderror" name="access_label" value="{{ old('access_label') }}" required autocomplete="access_label">
