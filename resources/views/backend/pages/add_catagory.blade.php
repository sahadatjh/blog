			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="{{route('store.catagory')}}">
                            @csrf
                            @method('POST')
						  <fieldset>
							...
							<div class="control-group">
							  	...
							  	<div class="controls">
									<input id="catagory_name" type="text" class="span6" name="catagory_name" value="{{ old('catagory_name') }}" required  autocomplete="catagory_name">
