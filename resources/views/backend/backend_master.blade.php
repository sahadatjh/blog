...
<head>
	...
	{{-- Toster css --}}
	<link rel="stylesheet" href="{{asset('public/backend/plugins/toster/toastr.min.css')}}" />
...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{route('catagories')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Manage Catagory</span></a></li>
						<li><a href="{{route('posts')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Posts</span></a></li>
						<li><a href="#"><i class="icon-eye-open"></i><span class="hidden-tablet">Manage User</span></a></li>
	...
	<!-- Toster js -->
	<script type="text/JavaScript" src="{{asset('public/backend/plugins/toster/toastr.min.js')}}" ></script>
